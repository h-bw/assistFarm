        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button
                        ...
                        icon="Plus"
                        @click="handleAdd"
                        v-hasPermi="['assisting:banner:add']"
                >新增
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                        ...
                        :disabled="single"
                        @click="handleUpdate"
                        v-hasPermi="['assisting:banner:edit']"
                >修改
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                        ...
                        :disabled="multiple"
                        @click="handleDelete"
                        v-hasPermi="['assisting:banner:remove']"
                >删除
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                        ...
                        icon="Download"
                        @click="handleExport"
                        v-hasPermi="['assisting:banner:export']"
                >导出
                </el-button>
            </el-col>
            <el-col :span="1.5">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                               v-hasPermi="['assisting:banner:edit']">修改
                    </el-button>
                    <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                               v-hasPermi="['assisting:banner:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
...
import {listBanner, getBanner, delBanner, addBanner, updateBanner} from "@/api/assisting/banner"
...
const data = reactive({
    ...
    upload: {
        ...
        // 上传的地址
        url: baseURL + "/assisting/banner/importData"
    }
})
...
/** 导出按钮操作 */
const handleExport = () => {
    proxy.download('assisting/banner/export', {
        ...queryParams.value
...
const importTemplate = () => {
    proxy.download('assisting/banner/importTemplate', {}, `template_${new Date().getTime()}.xlsx`)
}
